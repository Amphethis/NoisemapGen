Module Generation
    ...
    Sub PerlinOctaves(ZoomMax As Integer)
        ...
        FileOpen(1, ".\properties.txt", OpenMode.Input)
        Input(1, OctaveMin)
        Input(1, OctaveMax)
        Input(1, WaterThr)
        Input(1, SandThr)
        ...
        Dim Name As String = InputBox("Enter a filename")
        ...
        'item = New MapObject With {
        '.CentrePoint = New Point(Rnd() * 896 + 64, Rnd() * 896 + 64),
        '.ImageType = "orb"
        '}
